...
const posts = [
	...
	{
		title: "Kedilerde Tırnak Bakımı",
		slug: "kedilerde-tirnak-bakimi",
		excerpt:
			"Kedilerin tırnak bakımının önemi, düzenli bakım için ipuçları ve ev ortamında dikkat edilmesi gerekenler.",
		image: "https://placehold.co/800x600?text=Tirnak+Bakimi",
		date: "15 Şubat 2024",
		author: {
			name: "Dr. Ayşe Demir",
			image: "https://placehold.co/100x100?text=Dr.+Ayse",
	...
	{
		title: "Köpeklerde Kalp Sağlığı",
		slug: "kopeklerde-kalp-sagligi",
		excerpt:
			"Köpeklerde kalp hastalıklarının belirtileri, risk faktörleri ve koruyucu önlemler hakkında bilmeniz gerekenler.",
		image: "https://placehold.co/800x600?text=Kalp+Sagligi",
		date: "10 Şubat 2024",
		author: {
			name: "Dr. Mehmet Kaya",
			image: "https://placehold.co/100x100?text=Dr.+Mehmet",
	...
	{
		title: "Evcil Hayvanlarda Seyahat Rehberi",
		slug: "evcil-hayvanlarda-seyahat-rehberi",
		excerpt:
			"Evcil hayvanınızla seyahat ederken dikkat etmeniz gereken noktalar ve yolculuk öncesi hazırlıklar.",
		image: "https://placehold.co/800x600?text=Seyahat+Rehberi",
		date: "5 Şubat 2024",
		author: {
			name: "Dr. İrem İldiri",
			image: "https://placehold.co/100x100?text=Dr.+Irem",
	...
	{
		title: "Kedilerde Davranış Bozuklukları",
		slug: "kedilerde-davranis-bozukluklari",
		excerpt:
			"Kedilerde görülen yaygın davranış bozuklukları, nedenleri ve çözüm yöntemleri hakkında uzman görüşleri.",
		image: "https://placehold.co/800x600?text=Davranis+Bozukluklari",
		date: "1 Şubat 2024",
		author: {
			name: "Dr. Ahmet Yılmaz",
			image: "https://placehold.co/100x100?text=Dr.+Ahmet",
...
export default function Blog() {
	...
	// Mevcut sayfada gösterilecek blog yazılarını al
